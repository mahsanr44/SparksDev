                ...
                <div>
                    ...
                    <div className='flex justify-center items-center mt-12 space-x-20'>
                        ...
                        <div className='flex-col justify-center items-center space-y-4 '>
                            <div>
                            <input type="text" placeholder='name' className='px-3 font-bold pr-16 border-2  m-1 p-1' />
                            </div>
                            <div>
                            <input type="email" placeholder='email' className='px-3 font-bold pr-16  border-2 m-1 p-1' />
                            </div>
                            <div>
                            <textarea name="message" placeholder='message' className='pl-2 font-bold border-2  m-1 p-1' cols={30} rows={5}></textarea>
                            </div>
                            <div>
                                <Button txt='Send' />
                            </div>
