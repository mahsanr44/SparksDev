                ...
                <div >
                    <div className=' lg:p-10 p-5 md:flex lg:space-x-36 md:space-x-14  justify-center items-center lg:mx-20 pt-20 mt-20 '>
                        <div className='space-y-3'>
                            <h1 className='font-extrabold text-6xl bg-gradient-to-tl from-gray-300 to-primary bg-clip-text text-transparent'> Better Design for Your Digital Products</h1>
