                ...
                <div className="grid grid-cols-2 gap-5 px-4 py-6 md:space-x-16  lg:py-8 md:grid-cols-4">
                    <div>
                        <div className="max-w-fit">
                            <Link href={"/"} >
                                <h3 className="font-sans text-white font-bold  mb-6"> AhsanR </h3>
                            </Link>
                        </div>
                        <div className="flex  mb-5 w-fit">
                            <input type="text" placeholder="Enter your email" className="px-1  h-6 w-20 md:h-7 lg:h-8 lg:w-40 md:w-28" />
                            <button className='bg-green-500  text-white font-sans font-semibold text-sm  px-2 lg:px-5'>{"Submit"}</button>
                        </div>
